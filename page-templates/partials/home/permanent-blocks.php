...
?>
<section id="home-permanent-blocks" class="py-9 anchor">
        ...
        <div class="grid" style="--bs-columns: 12;">
          ...
          <div id="block1" class="block">
            <h3>
              <a href="<?php echo esc_attr($block1['link']); ?>"
                ...
                <span>
                  <?php echo esc_html($block1['title']); ?>
          ...
          <h3>  
              <a href="<?php echo esc_attr($block2['link']); ?>"
                ...
                <span>
                  <?php echo esc_html($block2['title']); ?>
                  <div class="underline"></div>
                </span>
              </a>
            </h3>
          ...
          <h3>
            <a href="<?php echo esc_attr($block4['link']); ?>"
              ...
              <span>
                <?php echo esc_html($block4['title']); ?>
                <div class="underline"></div>
              </span>
            </a>
          </h3>
          ...
          <div id="block4" class="block">
            <h3>
              <a href="<?php echo esc_attr($block3['link']); ?>"
                ...
                <span>
                  <?php echo esc_html($block3['title']); ?>
                  <div class="underline"></div>
                </span>
              </a>
            </h3>
          ...
          <div id="block5" class="block">
            <h3>
              <a href="<?php echo esc_attr($block5['link']); ?>"
                ...
                <span>
                  <?php echo esc_html($block5['title']); ?>
                  <div class="underline"></div>
                </span>
              </a>
            </h3>
          ...
          <div id="block6" class="block">
            <h3>
              <a href="<?php echo esc_attr($block6['link']); ?>"
                ...
                <span>
                  <?php echo esc_html($block6['title']); ?>
                  <div class="underline"></div>
                </span>
              </a>
            </h3>
          ...
          <div id="block7" class="block">
            <h3>
              <a href="<?php echo esc_attr($block7['link']); ?>"
                ...
                <span>
                  <?php echo esc_html($block7['title']); ?>
                  <div class="underline"></div>
                </span>
              </a>
            </h3>
          ...
          <div id="block8" class="block">
            <h3>
              <a href="<?php echo esc_attr($block8['link']); ?>"
                ...
                <span>
                  <?php echo esc_html($block8['title']); ?>
                  <div class="underline"></div>
                </span>
              </a>
            </h3>
