...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,i,n){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(i),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},x={animation:!0,autohide:!0,delay:5e3};class E extends r.default{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return x}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const t=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),e.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const e=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const i=e.relatedTarget;this._element===i||this._element.contains(i)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(e=>this._onInteraction(e,!0))),o.default.on(this._element,u,(e=>this._onInteraction(e,!1))),o.default.on(this._element,d,(e=>this._onInteraction(e,!0))),o.default.on(this._element,f,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=E.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return n.enableDismissTrigger(E),e.defineJQueryPlugin(E),E}(r(),c(),w(),A())}(Vt);var Kt,Yt,Xt,Ut=Vt.exports;Kt=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Yt=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Xt=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Kt||Yt||Xt)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1),document.addEventListener("scroll",(()=>{var e=window.scrollY;document.querySelector(".nav-overlay").style.opacity=(.8*(1-(400-e)/400)+.4).toString()})),jQuery(document).ready((function(){jQuery(".partner-carousel").slick({infinite:!0,arrows:!1,slidesToShow:5,slidesToScroll:1,autoplay:!0,autoplaySpeed:1e3,centerMode:!0,responsive:[{breakpoint:992,settings:{slidesToShow:3}},{breakpoint:768,settings:{slidesToShow:2}},{breakpoint:576,settings:{slidesToShow:1}}]}),jQuery(".artist-carousel").slick({infinite:!0,slidesToShow:5,slidesToScroll:1,autoplay:!0,autoplaySpeed:2e3,responsive:[{breakpoint:992,settings:{slidesToShow:3}},{breakpoint:576,settings:{slidesToShow:2}}]});for(let t=0;t<30;t++){jQuery(".gallery-display-"+t).slick({slidesToShow:1,slidesToScroll:1,arrows:!1,fade:!0,asNavFor:".gallery-carousel-"+t}),jQuery(".gallery-carousel-"+t).slick({infinite:!0,slidesToShow:9,slidesToScroll:1,asNavFor:".gallery-display-"+t,centerMode:!0,focusOnSelect:!0,autoplay:!0,autoplaySpeed:3e3,responsive:[{breakpoint:992,settings:{slidesToShow:7}},{breakpoint:768,settings:{slidesToShow:5}},{breakpoint:576,settings:{slidesToShow:3}}]});var e=document.getElementById("modal-gallery-"+t);e&&(St.getOrCreateInstance(e),e.addEventListener("shown.bs.modal",(e=>{jQuery(".gallery-carousel-"+t).slick("setPosition"),jQuery(".gallery-display-"+t).slick("setPosition")})))}}));const Jt=document.getElementById("artist-modal");Jt&&Jt.addEventListener("show.bs.modal",(e=>{const t=e.relatedTarget,i=t.getAttribute("data-bs-name"),n=t.getAttribute("data-bs-image"),s=t.getAttribute("data-bs-bio"),o=Jt.querySelector("#artist-modal-name"),r=Jt.querySelector("#artist-modal-image"),a=Jt.querySelector("#artist-modal-bio");o.textContent=i,r.src=n,a.textContent=s})),e.Alert=T,e.Button=k,e.Carousel=I,e.Collapse=M,e.Dropdown=vt,e.Modal=St,e.Offcanvas=jt,e.Popover=Bt,e.Scrollspy=zt,e.Tab=Qt,e.Toast=Ut,e.Tooltip=Rt}));
