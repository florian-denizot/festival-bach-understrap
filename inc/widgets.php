...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar( array(
			'id'            => 'footerend',
			'name'          => __( 'Footer End', 'understrap' ),
			'description'   => __( 'Footer end widget area', 'understrap' ),
			'before_widget' => '<div id="%1$s class="%2$s footer-end-widget">',
			'after_widget'  => '</div><!-- .footer-end-widget -->',
			'before_title'  => '<h4 class="widget-title">',
			'after_title'   => '</h4>',
		) );
